...
function AsyncFeedbackSection({ sessionId, clusters }: { sessionId: string; clusters: GoalClusterType[] }) {
  ...
  const handleStartFeedback = async () => {
    if (!sessionId || clusters.length === 0) return;
    setIsCreating(true);
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600 mb-3">
            Laat MT-leden op hun eigen tijd feedback geven op deze doelen.
            Ze kunnen opmerkingen plaatsen, tekst aanpassen en samenvoeg-suggesties doen.
          </p>
          ...
          {feedbackUrl ? (
            ...
            <button
              ...
              disabled={isCreating || clusters.length === 0}
